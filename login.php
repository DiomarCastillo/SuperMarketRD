...
<head>
  ...
  <title>SuperMarketRD| Login</title>
...
<body>
 <div class="container">
        <div class="card card-container">
            <img id="profile-img" class="profile-img-card" src="img/Login1.png" />
			...
			<div class="text-center">
				<a  href="formulariopass.php" name="olvidatecontraseña" >Olvidaste tu contraseña?</a>
			</div>
            </form><!-- /form -->
