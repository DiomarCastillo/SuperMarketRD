...
$numero_factura= $_SESSION['numero_compra'];
...
{
$insert_tmp=mysqli_query($con, "INSERT INTO detalle_compra (numero_compra, id_producto,cantidad,precio_compra) 
...
<?php
	$sumador_total=0;
	$sql=mysqli_query($con, "select * from productos, compras, detalle_compra where compras.numero_compra=detalle_compra.numero_compra and  compras.id_compra='$id_factura' and productos.id_producto=detalle_compra.id_producto");
	...
	$update=mysqli_query($con,"update compras set total_compra='$total_factura' where id_compra='$id_factura'");
?>
<tr>
