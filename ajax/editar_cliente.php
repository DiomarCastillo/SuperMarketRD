<?php
	...
	if (empty($_POST['mod_id'])) {
		...
		$cedula=mysqli_real_escape_string($con,(strip_tags($_POST["mod_cdula"],ENT_QUOTES)));
		...
		$sql="UPDATE clientes SET nombre_cliente='".$nombre."',cedula_cliente='".$cedula."', telefono_cliente='".$telefono."', email_cliente='".$email."', direccion_cliente='".$direccion."', status_cliente='".$estado."' WHERE id_cliente='".$id_cliente."'";
